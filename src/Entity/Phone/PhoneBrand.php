...
class PhoneBrand implements VariableInterface
{
    static $variables = [
        "[TELBRAND]" => "getName",
        "[URLTELBRAND]" => "getUrl",
        "[ENTELBRAND]" => "getBrandEn",
        "[RUTELBRAND]" => "getBrandRu",
        "[TEXTTELBRAND]" => "getText",
    ];
     ...
     * @var Collection
     *
     * One PhoneBrand has Many PhoneModels.
     * @ORM\OneToMany(targetEntity="PhoneModel", mappedBy="brand")
     */
    private $models;

    /**
     * PhoneBrand constructor.
     */
