 ...
 */
final class Version20181031042951 extends AbstractMigration
{
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE auto_spare_part_general_advert (id INT AUTO_INCREMENT NOT NULL, brand_id INT DEFAULT NULL, seller_advert_detail_id INT DEFAULT NULL, `condition` VARCHAR(255) NOT NULL, stock_type VARCHAR(255) NOT NULL, comment LONGTEXT NOT NULL, INDEX IDX_A658CE6D44F5D008 (brand_id), INDEX IDX_A658CE6D18291EB8 (seller_advert_detail_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE seller_advert_detail (id INT AUTO_INCREMENT NOT NULL, seller_data_id INT DEFAULT NULL, UNIQUE INDEX UNIQ_DE546044ECFB182D (seller_data_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE seller_advert_detail ADD CONSTRAINT FK_DE546044ECFB182D FOREIGN KEY (seller_data_id) REFERENCES seller_data (id)');

        $this->addSql('
            INSERT INTO seller_advert_detail (seller_data_id)
            SELECT id FROM seller_data
         ');
    }
