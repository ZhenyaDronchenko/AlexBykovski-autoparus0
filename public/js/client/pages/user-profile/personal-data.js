...
function citiesHideShow1() {

    var citiesElem = document.getElementById('hiddenCities1');
    var toggle3 = even_odd(n3);
    if (toggle3 ==true) {
        citiesElem.className = 'showC1';
        var showBElem = document.getElementById('showButton1');
        showBElem.textContent = '<<<<<<<';
    }
    
    else {
        citiesElem.className = 'hiddenC1';
        var showBElem = document.getElementById('showButton1');
        showBElem.textContent = '>>>>>>>';
    }
    n3 += 1;
